...
namespace FastFood_management1
{
    public partial class Form1 : Form
    {
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            receiptTextbox.AppendText("\t\t\t\J&M's Fast Food" + Environment.NewLine);
            receiptTextbox.AppendText("\t\t\t\t*****************" + Environment.NewLine);
            ...
            {
                count++;
                receiptTextbox.AppendText("\t" + Convert.ToString(count) + ".Fries:" + friestp + " Bdt" + Environment.NewLine);
                subtotal = subtotal + friestp;
                subTotallbl.Text ="" + Convert.ToString(subtotal) + " €/-";
            }
            if (burgerCheck.Checked == true)
            {
                count++;
                receiptTextbox.AppendText("\t" + Convert.ToString(count) + ".  Burger:" + burgertp + " Bdt" + Environment.NewLine);
            ...
            {
                count++;
                receiptTextbox.AppendText("\t" + Convert.ToString(count) + ".  Pizza:" + pizzatp + " Bdt" + Environment.NewLine);
            ...
            {
                count++;
                receiptTextbox.AppendText("\t" + Convert.ToString(count) + ".  Pasta:" + pastatp + " Bdt" + Environment.NewLine);
            ...
            {
                count++;
                receiptTextbox.AppendText("\t" + Convert.ToString(count) + ".  Noodles:" + noodlestp + " Bdt" + Environment.NewLine);
            ...
            {
                count++;
                receiptTextbox.AppendText("\t" + Convert.ToString(count) + ".  Swarma:" + swarmatp + " Bdt" + Environment.NewLine);
            ...
            {
                count++;
                receiptTextbox.AppendText("\t" + Convert.ToString(count) + ".  Meat-Balls:" + meatballtp + " Bdt" + Environment.NewLine);
            ...
            {
                count++;
                receiptTextbox.AppendText("\t" + Convert.ToString(count) + ".  Coka-Cola:" + coketp + " Bdt" + Environment.NewLine);
            ...
            {
                count++;
                receiptTextbox.AppendText("\t" + Convert.ToString(count) + ".  Mountain-Dew:" + dewtp + " Bdt" + Environment.NewLine);
            ...
            {
                count++;
                receiptTextbox.AppendText("\t" + Convert.ToString(count) + ".  ChocoShake:" + chocoshaketp + " Bdt" + Environment.NewLine);
            ...
            {
                count++;
                receiptTextbox.AppendText("\t" + Convert.ToString(count) + ".  MintShake:" + mintshakep + " Bdt" + Environment.NewLine);
            ...
            {
                count++;
                receiptTextbox.AppendText("\t" + Convert.ToString(count) + ".  Ice -Cream:" + icecreamtp + " Bdt" + Environment.NewLine);
            ...
            {
                count++;
                receiptTextbox.AppendText("\t"+Convert.ToString(count) +".  Pudding:" + puddingtp + " Bdt" + Environment.NewLine);
                subtotal = subtotal + puddingtp;
                subTotallbl.Text =  "" + Convert.ToString(subtotal) + " €/-";
            }
            tax = subtotal * 0.10;
            total = subtotal + tax;
            vatlbl.Text = Convert.ToString(tax) + " €/-";
